################################################################################
##
## Replication of Table2 in Weeden & Cornwell (2020) Soc.Sci
##
################################################################################
...
# current time
message(
    paste0("\nStart running 01_Fall19_replication.R on ", Sys.time())
)
...
saveRDS(bicomps, here("data", "bicomp2019.rds"))
...
saveRDS(g_one, here("data", "onemode19.rds"))

# get geodesic distances
d_mat = distances(g_one)
saveRDS(d_mat, here("data", "distances2019.rds"))
# d_mat = readRDS(here("data, distances2019.rds"))
...
saveRDS(res2019, here("data", "res2019.rds"))
